...
canvas16 = r.TCanvas("evpu", "evpu")
hist2.Draw("SURF1 CYL")
hist2.GetYaxis().SetTitle("#eta_{#gamma#gamma}")
hist2.GetXaxis().SetTitle("#phi_{#gamma#gamma}")
canvas16.SaveAs("EtavPhiWeightedcylsurf.png")

canvas15 = r.TCanvas("evpu", "evpu")
hist2.Draw("SURF1 SPH")
hist2.GetYaxis().SetTitle("#eta_{#gamma#gamma}")
hist2.GetXaxis().SetTitle("#phi_{#gamma#gamma}")
canvas15.SaveAs("EtavPhiWeightedsurfsphere.png")
...
canvas41 = r.TCanvas("evpu", "evpu")
hist4.Draw("SURF1 SPH")
hist4.GetYaxis().SetTitle("#eta_{#gamma#gamma}")
hist4.GetXaxis().SetTitle("#phi_{#gamma#gamma}")
canvas41.SaveAs("ThetavPhiWeightedsurfsphere.png")
